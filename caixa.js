...
function criaProduto () {
    ...
    if(tipoProduto.value === 'alimentacao') {
        ...
        produto = new Carro(nomeProduto.value, Number(valorProduto.value), codigoProduto.value, tipoProduto.value, dataProduto.value);
    } else if (tipoProduto.value === 'limpeza') {
        produto = new Limpeza(nomeProduto.value, Number(valorProduto.value), codigoProduto.value, tipoProduto.value, dataProduto.value);
    } else if (tipoProduto.value === 'outro') {
        produto = new Produto(nomeProduto.value, Number(valorProduto.value), codigoProduto.value, tipoProduto.value, dataProduto.value);
    }
    return produto;
}
